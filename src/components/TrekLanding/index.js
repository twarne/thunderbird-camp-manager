...
const TrekLanding = props => {
  ...
  const importantDates = [
    ...
    { title: 'Equipment Check', date: 'May 30, 2020', tbd: true },
    { title: 'Trek', date: 'June 8, 2022' }
  ];
            ...
            <Grid container item xs={12} className={classes.landingGridContent}>
              <Grid item xs={12}>
                <Typography variant="body1" paragraph>
                  Welcome to Thunderbird Park Stake Trek 2022! Trek will be a lasting memory and will help you establish
